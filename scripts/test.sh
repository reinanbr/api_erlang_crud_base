...
echo "🧪 Testando API CRUD Erlang..."

# Script para testar o teste de carga Gatling
cd /home/jezuis/Desktop/std/apis/erlang/api_erlang_crud_base

echo "📊 Criando script de teste Gatling..."

cat > test_gatling.sh << 'EOF'
#!/bin/bash
...
chmod +x test_gatling.sh

echo "✅ Script de teste criado: test_gatling.sh"
